window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\TESTDS\dsh-better-sidebar\src\client\sidebar.module.css.mjs
		const css$3 = ".nxAmeW_toggleCluster{z-index:55;flex-direction:row;gap:4px;display:flex;position:fixed;top:3px;right:10px}.nxAmeW_panel:not(.nxAmeW_panelHidden) .nxAmeW_tabBar{padding-right:72px}.nxAmeW_toggleButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out), color var(--ds-transition-duration-slow) var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;justify-content:center;align-items:center;display:flex}.nxAmeW_toggleButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.nxAmeW_toggleButton:disabled{opacity:.4;cursor:default}.nxAmeW_panel{z-index:50;background:var(--dsw-specific-sidebar-fill);border-left:1px solid var(--dsw-alias-border-l2);transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), width var(--ds-transition-duration-slow) var(--ds-ease-in-out);flex-direction:column;display:flex;position:fixed;top:0;bottom:0;right:0}.nxAmeW_panelHidden{pointer-events:none;visibility:hidden;transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), width var(--ds-transition-duration-slow) var(--ds-ease-in-out), visibility 0s linear var(--ds-transition-duration-slow);transform:translate(102%)}.nxAmeW_panel[data-dragging]{transition:none}.nxAmeW_panelResize{cursor:col-resize;z-index:2;touch-action:none;width:8px;position:absolute;top:0;bottom:0;left:-4px}.nxAmeW_panelResizeActive{background:var(--dsw-alias-interactive-bg-hover-accent)}.nxAmeW_panelBody{flex:1;min-width:0;min-height:0;display:flex}.nxAmeW_bottomPanel{z-index:50;background:var(--dsw-specific-sidebar-fill);border-top:1px solid var(--dsw-alias-border-l2);transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), height var(--ds-transition-duration-slow) var(--ds-ease-in-out);flex-direction:column;display:flex;position:fixed;bottom:0}.nxAmeW_bottomPanelHidden{pointer-events:none;visibility:hidden;transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), height var(--ds-transition-duration-slow) var(--ds-ease-in-out), visibility 0s linear var(--ds-transition-duration-slow);transform:translateY(102%)}.nxAmeW_bottomPanel[data-dragging]{transition:none}.nxAmeW_bottomResize{cursor:row-resize;z-index:2;touch-action:none;height:8px;position:absolute;top:-4px;left:0;right:0}.nxAmeW_bottomResizeActive{background:var(--dsw-alias-interactive-bg-hover-accent)}.nxAmeW_bottomClose{z-index:4;width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex;position:absolute;top:3px;right:6px}.nxAmeW_bottomClose:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.nxAmeW_bottomPanel .nxAmeW_tabBar{padding-right:40px}body[data-dsh-title-bar-compat] .nxAmeW_toggleCluster{top:calc(var(--dsh-title-bar-strip,40px) + 3px)}body[data-dsh-title-bar-compat] .nxAmeW_panel{padding-top:var(--dsh-title-bar-strip,40px)}.nxAmeW_cornerHandle{z-index:52;cursor:nwse-resize;touch-action:none;width:12px;height:12px;position:fixed}.nxAmeW_cornerHandle:hover,.nxAmeW_cornerHandle[data-dragging]{background:var(--dsw-alias-interactive-bg-hover-accent)}.nxAmeW_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.nxAmeW_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.nxAmeW_iconButton:disabled{opacity:.4;cursor:default}.nxAmeW_workbench,.nxAmeW_split{flex:1;min-width:0;min-height:0;display:flex}.nxAmeW_splitRow{flex-direction:row}.nxAmeW_splitCol{flex-direction:column}.nxAmeW_splitChild{display:flex;position:relative;overflow:hidden}.nxAmeW_divider{z-index:3;touch-action:none;flex:none;position:relative}.nxAmeW_dividerRow:after,.nxAmeW_dividerCol:after{content:\"\";background:var(--dsw-alias-border-l2);transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out);position:absolute}.nxAmeW_dividerRow{cursor:col-resize;width:7px;margin:0 -2px}.nxAmeW_dividerRow:after{width:1px;top:0;bottom:0;left:50%;transform:translate(-50%)}.nxAmeW_dividerCol{cursor:row-resize;height:7px;margin:-2px 0}.nxAmeW_dividerCol:after{height:1px;top:50%;left:0;right:0;transform:translateY(-50%)}.nxAmeW_divider:hover:after,.nxAmeW_dividerActive:after{background:var(--dsw-alias-interactive-bg-hover-accent)}.nxAmeW_pane{background:var(--dsw-alias-bg-base);flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;position:relative}.nxAmeW_paneDrop{outline:1px solid var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}.nxAmeW_dropOverlay{z-index:6;pointer-events:none;background:var(--dsw-alias-interactive-bg-hover-accent);opacity:.5;position:absolute}.nxAmeW_dropLeft{width:25%;top:0;bottom:0;left:0}.nxAmeW_dropRight{width:25%;top:0;bottom:0;right:0}.nxAmeW_dropUp{height:25%;top:0;left:0;right:0}.nxAmeW_dropDown{height:25%;bottom:0;left:0;right:0}.nxAmeW_dropCenter{outline:2px dashed var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-2px;background:0 0;inset:25%}.nxAmeW_paneContent{flex-direction:column;flex:1;min-height:0;display:flex;overflow:hidden}.nxAmeW_paneTab{flex-direction:column;flex:1;min-height:0;display:flex}.nxAmeW_paneTabHidden{display:none}.nxAmeW_paneEmptyCards{flex:1;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));align-content:start;gap:8px;min-height:0;padding:12px;display:grid;overflow:hidden}.nxAmeW_paneCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-strong-12);cursor:pointer;text-align:center;border-radius:8px;flex-direction:column;justify-content:center;align-items:center;gap:6px;padding:12px 8px;display:flex}.nxAmeW_paneCard:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-border-l2)}.nxAmeW_paneCard:disabled{opacity:.45;cursor:default}.nxAmeW_tabBar{border-bottom:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);flex:none;align-items:stretch;height:34px;display:flex}.nxAmeW_tabBarDrop{outline:1px dashed var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}.nxAmeW_tabList{scrollbar-width:none;flex:1;min-width:0;display:flex;overflow-x:auto}.nxAmeW_tabList::-webkit-scrollbar{display:none}.nxAmeW_tab{min-width:64px;max-width:160px;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary);border-right:1px solid var(--dsw-alias-border-l1);cursor:pointer;user-select:none;background:0 0;flex:none;align-items:center;gap:4px;padding:0 4px 0 10px;display:flex}.nxAmeW_tab:hover{background:var(--dsw-alias-interactive-bg-hover)}.nxAmeW_tabActive{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-active)}.nxAmeW_tabTitle{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.nxAmeW_tabBadge{min-width:16px;height:15px;font:var(--dsw-font-xxxs-strong-11);background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-brand-primary);border-radius:8px;flex:none;justify-content:center;align-items:center;padding:0 4px;display:inline-flex}.nxAmeW_tabClose{width:18px;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.nxAmeW_tabClose:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.nxAmeW_tabBarPlus{background:var(--dsw-alias-bg-layer-1);width:22px;height:22px;color:var(--dsw-alias-label-tertiary);cursor:pointer;border:none;border-radius:5px;flex:none;justify-content:center;align-self:center;align-items:center;margin:0 6px;padding:0;display:inline-flex;position:sticky;right:0}.nxAmeW_tabBarPlus:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.nxAmeW_explorer{flex-direction:column;flex:1;min-height:0;display:flex}.nxAmeW_explorerHeader{flex:none;justify-content:space-between;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}.nxAmeW_explorerRoot{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.nxAmeW_explorerBody{flex:1;min-height:0;padding:2px 6px 8px;overflow-y:auto}.nxAmeW_explorerRow{width:100%;height:34px;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;white-space:nowrap;animation:nxAmeW_dsh-row-in .15s var(--ds-ease-in-out);background:0 0;border:none;border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.nxAmeW_explorerRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.nxAmeW_explorerDir{font:var(--dsw-font-s-strong-14)}.nxAmeW_explorerHidden{opacity:.45}.nxAmeW_explorerName{text-overflow:ellipsis;overflow:hidden}.nxAmeW_explorerRef{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);height:20px;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;border-radius:999px;flex:none;align-items:center;padding:0 8px;display:none}.nxAmeW_explorerRef:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.nxAmeW_explorerRow:hover .nxAmeW_explorerRef,.nxAmeW_explorerRow:focus-within .nxAmeW_explorerRef{display:inline-flex}.nxAmeW_explorerCopied{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}.nxAmeW_explorerError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);cursor:default}@keyframes nxAmeW_dsh-row-in{0%{opacity:0}}.nxAmeW_explorerEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;padding:16px}.nxAmeW_editor{flex-direction:column;flex:1;min-height:0;display:flex}.nxAmeW_editorHeader{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:6px;padding:4px 8px;display:flex}.nxAmeW_editorTitle{min-width:0;font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}.nxAmeW_editorStatus{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary)}.nxAmeW_editorStatusError{color:var(--dsw-alias-state-error-primary)}.nxAmeW_dirtyDot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;flex:none;width:7px;height:7px}.nxAmeW_editorPlaceholder{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;flex:1;justify-content:center;align-items:center;padding:16px;display:flex}.nxAmeW_orphanedType{opacity:.7;overflow-wrap:anywhere;margin-top:8px;font-size:12px;display:block}.nxAmeW_editorBinary{text-align:center;flex-direction:column;flex:1;justify-content:center;align-items:center;gap:12px;padding:24px 16px;display:flex}.nxAmeW_editorBinaryNotice{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}.nxAmeW_editorDownloadLink{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-strong-12);cursor:pointer;transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out), border-color var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:6px;align-items:center;gap:6px;padding:6px 14px;text-decoration:none;display:inline-flex}.nxAmeW_editorDownloadLink:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-border-l2)}.nxAmeW_editorError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);padding:12px 16px}.nxAmeW_editorBanner{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex:none;padding:4px 12px}.nxAmeW_sandboxStatus{font:var(--dsw-font-xxxs-11);flex:none;align-items:center;gap:8px;padding:4px 10px;display:flex}.nxAmeW_sandboxStatusOn{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);border-bottom:1px solid var(--dsw-alias-border-l1)}.nxAmeW_sandboxStatusOff{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 10%, transparent);border-bottom:1px solid color-mix(in srgb, var(--dsw-alias-state-error-primary) 45%, transparent)}.nxAmeW_sandboxDot{background:var(--dsw-alias-state-success-primary);border-radius:50%;flex:none;width:6px;height:6px}.nxAmeW_sandboxStatusOff .nxAmeW_sandboxDot{background:var(--dsw-alias-state-error-primary)}.nxAmeW_sandboxStatusText{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.nxAmeW_sandboxAction{border:1px solid var(--dsw-alias-border-l2);font:inherit;color:inherit;cursor:pointer;background:0 0;border-radius:6px;flex:none;padding:2px 8px}.nxAmeW_sandboxAction:hover{background:var(--dsw-alias-interactive-bg-hover)}.nxAmeW_editorHtml{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%;min-height:0}.nxAmeW_browser{flex-direction:column;flex:1;min-height:0;display:flex}.nxAmeW_browserBar{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:4px;padding:6px 8px;display:flex}.nxAmeW_browserInput{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;height:28px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 10px}.nxAmeW_browserInput:focus{border-color:var(--dsw-alias-border-l2);outline:none}.nxAmeW_browserMessage{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex:none;padding:4px 12px}.nxAmeW_browserFrame{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%;min-height:0}.nxAmeW_browserStart{text-align:center;min-height:0;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);flex:1;justify-content:center;align-items:center;padding:20px;display:flex}.nxAmeW_browserBlocked{text-align:center;min-height:0;color:var(--dsw-alias-state-warn-primary);flex-direction:column;flex:1;justify-content:center;align-items:center;gap:6px;padding:24px;display:flex}.nxAmeW_browserBlockedTitle{font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-primary)}.nxAmeW_browserBlockedDesc{max-width:280px;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-secondary)}.nxAmeW_browserBlockedActions{gap:8px;margin-top:6px;display:flex}.nxAmeW_browserBlockedButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxxs-11);cursor:pointer;border-radius:6px;padding:4px 12px}.nxAmeW_browserBlockedButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.nxAmeW_editorCm{background:0 0;flex:1;min-height:0;overflow:hidden}.nxAmeW_editorCmHidden{display:none}.nxAmeW_editorCm .cm-editor{height:100%}.nxAmeW_editorCm .cm-editor.cm-focused{outline:none}.nxAmeW_editorModeToggle{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:6px;flex:none;align-items:center;gap:2px;padding:2px;display:inline-flex}.nxAmeW_editorModeButton{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-11);cursor:pointer;background:0 0;border:none;border-radius:4px;padding:2px 8px}.nxAmeW_editorModeButton:hover{color:var(--dsw-alias-label-primary)}.nxAmeW_editorModeActive{background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary)}.nxAmeW_editorImageWrap{flex:1;justify-content:center;align-items:center;min-height:0;padding:12px;display:flex;overflow:auto}.nxAmeW_editorImage{object-fit:contain;max-width:100%;max-height:100%}.nxAmeW_editorMd{min-height:0;font:var(--dsw-font-xs-13);flex:1;padding:10px 14px;overflow-y:auto}.nxAmeW_selectionPopup{z-index:60;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);height:28px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxxs-strong-11);white-space:nowrap;cursor:pointer;border-radius:6px;align-items:center;padding:0 10px;display:inline-flex;position:fixed;transform:translate(-50%,calc(-100% - 8px))}.nxAmeW_selectionPopup:hover{background:var(--dsw-alias-interactive-bg-hover)}.nxAmeW_editorPdf{background:var(--dsw-alias-bg-base);flex-direction:column;flex:1;min-height:0;display:flex}.nxAmeW_editorPdfToolbar{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;justify-content:flex-end;padding:6px 8px;display:flex}.nxAmeW_editorPdfStage{flex:1;min-height:0;display:flex;position:relative}.nxAmeW_editorPdfFrame{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%;min-height:0}.nxAmeW_editorPdfFrameBlocked{pointer-events:none}.nxAmeW_editorPdfDragShield{z-index:4;pointer-events:none;background:0 0;position:absolute;inset:0}.nxAmeW_editorPdfDragShieldActive{pointer-events:auto}body[data-dsh-tab-dragging] .nxAmeW_editorPdfFrame{pointer-events:none!important}body[data-dsh-tab-dragging] .nxAmeW_editorPdfDragShield{pointer-events:auto!important}.nxAmeW_terminalWrap{background:var(--dsw-alias-bg-base);flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.nxAmeW_terminal{flex:1;min-height:0;padding:6px 4px 6px 8px}.nxAmeW_terminal .xterm{height:100%}.nxAmeW_terminalBanner{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:3px 10px;display:flex}.nxAmeW_terminalBannerUrl{word-break:break-all;opacity:.85;flex-basis:100%;font-family:ui-monospace,SFMono-Regular,Menlo,monospace}.nxAmeW_boundaryError{z-index:50;background:var(--dsw-alias-bg-layer-1);border-left:1px solid var(--dsw-alias-border-l2);font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);flex-direction:column;align-items:flex-start;gap:8px;padding:16px;display:flex;position:fixed;top:0;bottom:0;right:0;overflow:auto}.nxAmeW_terminalRetry{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;border-radius:999px;flex:none;padding:1px 8px}.nxAmeW_terminalRetry:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.nxAmeW_tabBoundaryError{min-height:0;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);flex-direction:column;flex:1;align-items:flex-start;gap:8px;padding:12px 16px;display:flex;overflow:auto}.nxAmeW_git{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;overflow:hidden auto}.nxAmeW_gitHeader{flex:none;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}.nxAmeW_gitBranchSelect{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 6px}.nxAmeW_gitSection{border-top:1px solid var(--dsw-alias-border-l1)}.nxAmeW_gitSectionHeader{font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-tertiary);text-transform:uppercase;justify-content:space-between;align-items:center;padding:6px 12px 4px;display:flex}.nxAmeW_gitLink{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-brand-primary);cursor:pointer;background:0 0;border:none;padding:0}.nxAmeW_gitLink:hover:not(:disabled){text-decoration:underline}.nxAmeW_gitLink:disabled{opacity:.4;cursor:default}.nxAmeW_gitRow{min-height:34px;animation:nxAmeW_dsh-row-in .15s var(--ds-ease-in-out);border-radius:8px;align-items:center;gap:6px;margin:0 6px;padding:0 8px;display:flex}.nxAmeW_gitRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.nxAmeW_gitRowSelected{background:var(--dsw-alias-interactive-bg-active)}.nxAmeW_gitRowMain{cursor:pointer;text-align:left;background:0 0;border:none;flex:1;align-items:center;gap:8px;min-width:0;padding:3px 0;display:flex}.nxAmeW_gitBadge{width:20px;height:16px;font:var(--dsw-font-xxxs-strong-11);background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;justify-content:center;align-items:center;display:inline-flex}.nxAmeW_gitName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}.nxAmeW_gitEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);padding:4px 12px 8px}.nxAmeW_gitPlaceholder{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;padding:16px}.nxAmeW_gitError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);white-space:pre-wrap;padding:8px 12px}.nxAmeW_gitDiff{border-top:1px solid var(--dsw-alias-border-l1);padding:8px}.nxAmeW_gitDiffTab{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;overflow:hidden auto}.nxAmeW_gitDiffTabHeader{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}.nxAmeW_gitDiffTabTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}.nxAmeW_gitDiffFile{align-items:baseline;gap:6px;padding:8px 2px 2px;display:flex}.nxAmeW_gitDiffFilePath{font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.nxAmeW_gitDiffFileOld{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:none;max-width:40%;overflow:hidden}.nxAmeW_gitDiffFileTag{border:1px solid var(--dsw-alias-border-l2);font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:0 6px}.nxAmeW_gitDiffHunk{font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-tertiary);gap:8px;padding:3px 2px;display:flex}.nxAmeW_gitDiffHunkHeader{color:var(--dsw-alias-label-secondary);flex:none}.nxAmeW_gitDiffHunkSection{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.nxAmeW_gitDiffLine{font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;align-items:stretch;min-width:0;line-height:20px;display:flex}.nxAmeW_gitDiffNum{text-align:right;width:36px;color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;padding-right:8px}.nxAmeW_gitDiffCode{flex:1;min-width:0;overflow:visible}.nxAmeW_gitDiffCtx{color:var(--dsw-alias-label-primary)}.nxAmeW_gitDiffDel{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, transparent)}.nxAmeW_gitDiffAdd{color:var(--dsw-alias-state-success-primary);background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 12%, transparent)}.nxAmeW_gitDiffMeta{padding-left:2px}.nxAmeW_gitDiffMetaText{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);font-style:italic}.nxAmeW_gitDiffExpand{width:100%;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-brand-primary);cursor:pointer;text-align:center;background:0 0;border:none;margin:4px 0;display:block}.nxAmeW_gitDiffExpand:hover{background:var(--dsw-alias-interactive-bg-hover)}.nxAmeW_gitConfirmDesc{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);white-space:pre-wrap;margin:0}.nxAmeW_gitCommit{border-top:1px solid var(--dsw-alias-border-l1);align-items:center;gap:6px;padding:8px 12px;display:flex}.nxAmeW_gitCommitInput{flex:1;min-width:0}.nxAmeW_gitCommitButton{background:var(--dsw-alias-button-primary-fill);height:26px;color:var(--dsw-alias-label-primary-inverted);font:var(--dsw-font-xxs-strong-12);cursor:pointer;border:none;border-radius:6px;flex:none;padding:0 12px}.nxAmeW_gitCommitButton:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover)}.nxAmeW_gitCommitButton:disabled{opacity:.45;cursor:default}.nxAmeW_gitLogRow{cursor:pointer;border-radius:8px;flex-direction:column;gap:2px;padding:5px 12px;display:flex}.nxAmeW_gitLogRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.nxAmeW_gitLogLine1{align-items:baseline;gap:8px;min-width:0;display:flex}.nxAmeW_gitLogHash{font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-tertiary);flex:none}.nxAmeW_gitLogLine2{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;display:flex}.nxAmeW_gitLogRef{border:1px solid var(--dsw-alias-border-l2);font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-brand-primary);white-space:nowrap;border-radius:999px;flex:none;padding:0 5px}.nxAmeW_gitLogSubject{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}.nxAmeW_gitLogMeta{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary)}.nxAmeW_gitLogMore{border:1px solid var(--dsw-alias-border-l2);width:calc(100% - 24px);font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:6px;margin:4px 12px 8px;padding:6px 0;display:block}.nxAmeW_gitLogMore:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.nxAmeW_gitLogMore:disabled{opacity:.5;cursor:default}.nxAmeW_producedRow{flex-wrap:wrap;align-items:center;gap:8px;padding:4px 0;display:flex}.nxAmeW_producedLabel{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}.nxAmeW_producedChip{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-width:200px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);cursor:pointer;border-radius:999px;align-items:center;gap:4px;padding:2px 8px;display:inline-flex;overflow:hidden}.nxAmeW_producedChip:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.nxAmeW_producedChip span{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.nxAmeW_producedMore{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}.nxAmeW_toggleButton:focus-visible,.nxAmeW_bottomClose:focus-visible,.nxAmeW_iconButton:focus-visible,.nxAmeW_tab:focus-visible,.nxAmeW_tabClose:focus-visible,.nxAmeW_tabBarPlus:focus-visible,.nxAmeW_paneCard:focus-visible,.nxAmeW_explorerRow:focus-visible,.nxAmeW_explorerRef:focus-visible,.nxAmeW_gitRowMain:focus-visible,.nxAmeW_gitLink:focus-visible,.nxAmeW_gitCommitButton:focus-visible,.nxAmeW_gitLogRow:focus-visible,.nxAmeW_gitLogMore:focus-visible,.nxAmeW_gitDiffExpand:focus-visible,.nxAmeW_terminalRetry:focus-visible,.nxAmeW_editorModeButton:focus-visible,.nxAmeW_editorDownloadLink:focus-visible,.nxAmeW_editorPptxButton:focus-visible,.nxAmeW_editorDocxZoomRange:focus-visible{outline:2px solid var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}@media (prefers-reduced-motion:reduce){.nxAmeW_panel,.nxAmeW_panelHidden,.nxAmeW_bottomPanel,.nxAmeW_bottomPanelHidden,.nxAmeW_toggleCluster,.nxAmeW_toggleButton,.nxAmeW_tab,.nxAmeW_tabBarPlus,.nxAmeW_paneCard,.nxAmeW_explorerRow,.nxAmeW_gitRow,.nxAmeW_divider,.nxAmeW_dividerRow:after,.nxAmeW_dividerCol:after{transition:none;animation:none}}@media (width<=767px){.nxAmeW_panel:not(.nxAmeW_panelHidden) .nxAmeW_tabBar{padding-right:40px}.nxAmeW_tab{min-width:48px;max-width:128px}}";
		...
		var sidebar_module_css_default = {
			"workbench": "nxAmeW_workbench",
			"gitLogMeta": "nxAmeW_gitLogMeta",
			"gitLogSubject": "nxAmeW_gitLogSubject",
			"sandboxStatusOn": "nxAmeW_sandboxStatusOn",
			"gitLogMore": "nxAmeW_gitLogMore",
			"panel": "nxAmeW_panel",
			"browserBlocked": "nxAmeW_browserBlocked",
			"gitLink": "nxAmeW_gitLink",
			"paneCard": "nxAmeW_paneCard",
			"tabActive": "nxAmeW_tabActive",
			"orphanedType": "nxAmeW_orphanedType",
			"editorPdfFrameBlocked": "nxAmeW_editorPdfFrameBlocked",
			"terminalBannerUrl": "nxAmeW_terminalBannerUrl",
			"editorStatusError": "nxAmeW_editorStatusError",
			"gitDiffDel": "nxAmeW_gitDiffDel",
			"gitConfirmDesc": "nxAmeW_gitConfirmDesc",
			"editorHeader": "nxAmeW_editorHeader",
			"editorBinaryNotice": "nxAmeW_editorBinaryNotice",
			"sandboxStatusText": "nxAmeW_sandboxStatusText",
			"explorerName": "nxAmeW_explorerName",
			"boundaryError": "nxAmeW_boundaryError",
			"splitChild": "nxAmeW_splitChild",
			"editorTitle": "nxAmeW_editorTitle",
			"editorDownloadLink": "nxAmeW_editorDownloadLink",
			"gitDiffMeta": "nxAmeW_gitDiffMeta",
			"browserBlockedActions": "nxAmeW_browserBlockedActions",
			"gitDiffNum": "nxAmeW_gitDiffNum",
			"toggleButton": "nxAmeW_toggleButton",
			"bottomClose": "nxAmeW_bottomClose",
			"gitPlaceholder": "nxAmeW_gitPlaceholder",
			"gitDiffExpand": "nxAmeW_gitDiffExpand",
			"gitLogRow": "nxAmeW_gitLogRow",
			"gitLogLine2": "nxAmeW_gitLogLine2",
			"editorModeToggle": "nxAmeW_editorModeToggle",
			"split": "nxAmeW_split",
			"gitSection": "nxAmeW_gitSection",
			"dropLeft": "nxAmeW_dropLeft",
			"gitLogLine1": "nxAmeW_gitLogLine1",
			"gitBranchSelect": "nxAmeW_gitBranchSelect",
			"dirtyDot": "nxAmeW_dirtyDot",
			"gitDiffFile": "nxAmeW_gitDiffFile",
			"gitLogHash": "nxAmeW_gitLogHash",
			"editorStatus": "nxAmeW_editorStatus",
			"editorImageWrap": "nxAmeW_editorImageWrap",
			"gitDiff": "nxAmeW_gitDiff",
			"dropOverlay": "nxAmeW_dropOverlay",
			"gitDiffMetaText": "nxAmeW_gitDiffMetaText",
			"bottomResize": "nxAmeW_bottomResize",
			"splitRow": "nxAmeW_splitRow",
			"splitCol": "nxAmeW_splitCol",
			"dropRight": "nxAmeW_dropRight",
			"browserBlockedButton": "nxAmeW_browserBlockedButton",
			"tabClose": "nxAmeW_tabClose",
			"editorError": "nxAmeW_editorError",
			"pane": "nxAmeW_pane",
			"gitEmpty": "nxAmeW_gitEmpty",
			"terminalBanner": "nxAmeW_terminalBanner",
			"gitDiffTabTitle": "nxAmeW_gitDiffTabTitle",
			"gitDiffFilePath": "nxAmeW_gitDiffFilePath",
			"editorPdfDragShieldActive": "nxAmeW_editorPdfDragShieldActive",
			"paneDrop": "nxAmeW_paneDrop",
			"gitBadge": "nxAmeW_gitBadge",
			"selectionPopup": "nxAmeW_selectionPopup",
			"toggleCluster": "nxAmeW_toggleCluster",
			"dividerRow": "nxAmeW_dividerRow",
			"browser": "nxAmeW_browser",
			"explorerCopied": "nxAmeW_explorerCopied",
			"editorModeActive": "nxAmeW_editorModeActive",
			"tabBadge": "nxAmeW_tabBadge",
			"dsh-row-in": "nxAmeW_dsh-row-in",
			"sandboxDot": "nxAmeW_sandboxDot",
			"tabTitle": "nxAmeW_tabTitle",
			"explorerHeader": "nxAmeW_explorerHeader",
			"browserFrame": "nxAmeW_browserFrame",
			"browserStart": "nxAmeW_browserStart",
			"editorModeButton": "nxAmeW_editorModeButton",
			"gitCommitInput": "nxAmeW_gitCommitInput",
			"divider": "nxAmeW_divider",
			"sandboxStatusOff": "nxAmeW_sandboxStatusOff",
			"gitDiffCode": "nxAmeW_gitDiffCode",
			"gitLogRef": "nxAmeW_gitLogRef",
			"terminalWrap": "nxAmeW_terminalWrap",
			"tab": "nxAmeW_tab",
			"tabBarDrop": "nxAmeW_tabBarDrop",
			"paneEmptyCards": "nxAmeW_paneEmptyCards",
			"explorer": "nxAmeW_explorer",
			"paneTabHidden": "nxAmeW_paneTabHidden",
			"terminal": "nxAmeW_terminal",
			"panelResizeActive": "nxAmeW_panelResizeActive",
			"gitRow": "nxAmeW_gitRow",
			"tabBar": "nxAmeW_tabBar",
			"sandboxStatus": "nxAmeW_sandboxStatus",
			"gitSectionHeader": "nxAmeW_gitSectionHeader",
			"gitRowSelected": "nxAmeW_gitRowSelected",
			"gitDiffHunk": "nxAmeW_gitDiffHunk",
			"gitDiffLine": "nxAmeW_gitDiffLine",
			"explorerRow": "nxAmeW_explorerRow",
			"editorPptxButton": "nxAmeW_editorPptxButton",
			"dropCenter": "nxAmeW_dropCenter",
			"editorBanner": "nxAmeW_editorBanner",
			"browserBlockedDesc": "nxAmeW_browserBlockedDesc",
			"editorPdfToolbar": "nxAmeW_editorPdfToolbar",
			"bottomPanel": "nxAmeW_bottomPanel",
			"terminalRetry": "nxAmeW_terminalRetry",
			"gitRowMain": "nxAmeW_gitRowMain",
			"gitDiffFileOld": "nxAmeW_gitDiffFileOld",
			"gitError": "nxAmeW_gitError",
			"sandboxAction": "nxAmeW_sandboxAction",
			"gitName": "nxAmeW_gitName",
			"cornerHandle": "nxAmeW_cornerHandle",
			"producedLabel": "nxAmeW_producedLabel",
			"producedRow": "nxAmeW_producedRow",
			"editor": "nxAmeW_editor",
			"paneTab": "nxAmeW_paneTab",
			"editorImage": "nxAmeW_editorImage",
			"editorHtml": "nxAmeW_editorHtml",
			"panelHidden": "nxAmeW_panelHidden",
			"editorPlaceholder": "nxAmeW_editorPlaceholder",
			"browserInput": "nxAmeW_browserInput",
			"gitDiffTab": "nxAmeW_gitDiffTab",
			"bottomResizeActive": "nxAmeW_bottomResizeActive",
			"browserBar": "nxAmeW_browserBar",
			"editorDocxZoomRange": "nxAmeW_editorDocxZoomRange",
			"explorerBody": "nxAmeW_explorerBody",
			"dividerCol": "nxAmeW_dividerCol",
			"browserMessage": "nxAmeW_browserMessage",
			"paneContent": "nxAmeW_paneContent",
			"dividerActive": "nxAmeW_dividerActive",
			"gitDiffHunkSection": "nxAmeW_gitDiffHunkSection",
			"tabBarPlus": "nxAmeW_tabBarPlus",
			"editorPdfStage": "nxAmeW_editorPdfStage",
			"explorerDir": "nxAmeW_explorerDir",
			"explorerRef": "nxAmeW_explorerRef",
			"gitDiffAdd": "nxAmeW_gitDiffAdd",
			"gitCommit": "nxAmeW_gitCommit",
			"explorerError": "nxAmeW_explorerError",
			"editorCm": "nxAmeW_editorCm",
			"panelBody": "nxAmeW_panelBody",
			"gitCommitButton": "nxAmeW_gitCommitButton",
			"bottomPanelHidden": "nxAmeW_bottomPanelHidden",
			"explorerEmpty": "nxAmeW_explorerEmpty",
			"editorBinary": "nxAmeW_editorBinary",
			"gitDiffTabHeader": "nxAmeW_gitDiffTabHeader",
			"editorPdfFrame": "nxAmeW_editorPdfFrame",
			"gitHeader": "nxAmeW_gitHeader",
			"editorCmHidden": "nxAmeW_editorCmHidden",
			"dropUp": "nxAmeW_dropUp",
			"explorerRoot": "nxAmeW_explorerRoot",
			"gitDiffFileTag": "nxAmeW_gitDiffFileTag",
			"editorPdfDragShield": "nxAmeW_editorPdfDragShield",
			"producedChip": "nxAmeW_producedChip",
			"producedMore": "nxAmeW_producedMore",
			"explorerHidden": "nxAmeW_explorerHidden",
			"tabBoundaryError": "nxAmeW_tabBoundaryError",
			"gitDiffCtx": "nxAmeW_gitDiffCtx",
			"gitDiffHunkHeader": "nxAmeW_gitDiffHunkHeader",
			"tabList": "nxAmeW_tabList",
			"editorMd": "nxAmeW_editorMd",
			"dropDown": "nxAmeW_dropDown",
			"browserBlockedTitle": "nxAmeW_browserBlockedTitle",
			"editorPdf": "nxAmeW_editorPdf",
			"panelResize": "nxAmeW_panelResize",
			"iconButton": "nxAmeW_iconButton",
			"git": "nxAmeW_git"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\TESTDS\dsh-better-sidebar\src\client\SubagentView.module.css.mjs
		const css$2 = "._2R3-3W_subagent{flex-direction:column;flex:1;min-height:0;display:flex}._2R3-3W_subagentHeader{flex:none;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}._2R3-3W_subagentTitle{min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}._2R3-3W_subagentCount{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}._2R3-3W_subagentRefresh{width:24px;height:24px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;display:inline-flex}._2R3-3W_subagentRefresh:hover{background:var(--dsw-alias-interactive-bg-hover)}._2R3-3W_subagentBody{flex:1;min-height:0;padding:2px 6px 8px;overflow-y:auto}._2R3-3W_subagentRow{box-sizing:border-box;width:100%;min-height:50px;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;display:flex;position:relative}._2R3-3W_subagentRow:hover,._2R3-3W_subagentRow:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}._2R3-3W_subagentRowActive,._2R3-3W_subagentRowActive:hover,._2R3-3W_subagentRowActive:focus-visible{background:var(--dsw-alias-interactive-bg-active)}._2R3-3W_subagentRowDisabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}._2R3-3W_subagentRowDisabled:hover{background:0 0}._2R3-3W_subagentRowLoading{cursor:default}._2R3-3W_subagentDot{margin-top:4px}._2R3-3W_subagentContent{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}._2R3-3W_subagentLabel,._2R3-3W_subagentSecondary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._2R3-3W_subagentLabel{color:inherit;font-weight:400}._2R3-3W_subagentSecondary{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary)}._2R3-3W_subagentLive{min-width:0;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:4px;display:flex;overflow:hidden}._2R3-3W_subagentLiveTool{font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-secondary);flex:none}._2R3-3W_subagentLiveArgs{min-width:0;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);line-height:var(--dsw-font-xxxs-11-line-height);color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._2R3-3W_subagentLiveText{-webkit-line-clamp:2;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-secondary);-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}._2R3-3W_subagentNode{min-width:0;position:relative}._2R3-3W_subagentChildren{margin-left:18px;padding-left:4px;position:relative}._2R3-3W_subagentChildren:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);height:26px;position:absolute;top:-26px;left:0}._2R3-3W_subagentChildren[aria-busy=true]:before{content:none}._2R3-3W_subagentChildren>._2R3-3W_subagentNode:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;top:0;bottom:0;left:-4px}._2R3-3W_subagentChildren>._2R3-3W_subagentNode:last-child:before{height:17px;bottom:auto}._2R3-3W_subagentChildren>._2R3-3W_subagentNode>._2R3-3W_subagentRow:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}._2R3-3W_subagentEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;flex-direction:column;gap:2px;padding:16px;display:flex}._2R3-3W_subagentEmptyHint{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-dimmed)}._2R3-3W_subagentError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:8px;padding:8px 10px;display:flex}._2R3-3W_subagentErrorRetry{height:24px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;padding:0 8px;display:inline-flex}._2R3-3W_subagentErrorRetry:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._2R3-3W_jobs{border-top:1px solid var(--dsw-alias-border-l2);margin-top:10px;padding-top:8px}._2R3-3W_jobsHeader{align-items:center;gap:8px;height:26px;padding:0 2px;display:flex}._2R3-3W_jobsTitle{min-width:0;font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}._2R3-3W_jobsCount{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}._2R3-3W_jobsList{flex-direction:column;gap:2px;margin:0;padding:0;list-style:none;display:flex}._2R3-3W_jobsRow{border-radius:8px;align-items:center;gap:4px;display:flex}._2R3-3W_jobsRow:hover{background:var(--dsw-alias-interactive-bg-hover)}._2R3-3W_jobsRowSettled{opacity:.8}._2R3-3W_jobsRowSelected,._2R3-3W_jobsRowSelected:hover{background:var(--dsw-alias-interactive-bg-active)}._2R3-3W_jobsRowMain{min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:8px;outline:none;flex:1;align-items:flex-start;gap:8px;padding:6px 8px 6px 11px;display:flex}._2R3-3W_jobsRowMain:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}._2R3-3W_jobsDot{margin-top:5px}._2R3-3W_jobsContent{flex-direction:column;gap:1px;min-width:0;display:flex}._2R3-3W_jobsLabelLine{align-items:center;gap:6px;min-width:0;display:flex}._2R3-3W_jobsKind{text-overflow:ellipsis;white-space:nowrap;border:1px solid var(--dsw-alias-border-l2);max-width:90px;font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-tertiary);border-radius:4px;flex:none;padding:0 5px;line-height:14px;overflow:hidden}._2R3-3W_jobsLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);line-height:var(--dsw-font-xxxs-11-line-height);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}._2R3-3W_jobsSecondary{text-overflow:ellipsis;white-space:nowrap;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);overflow:hidden}._2R3-3W_jobsKill{width:22px;height:22px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;margin-right:4px;display:inline-flex}._2R3-3W_jobsKill:hover{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, transparent);color:var(--dsw-alias-state-error-primary)}._2R3-3W_jobsKillArmed,._2R3-3W_jobsKillArmed:hover{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, transparent);width:auto;height:20px;color:var(--dsw-alias-state-error-primary);font:var(--dsw-font-xxxs-strong-11);white-space:nowrap;padding:0 8px}._2R3-3W_jobsKill:disabled{opacity:.5;cursor:default}._2R3-3W_jobsKillError{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-error-primary);flex:none;margin-right:4px}._2R3-3W_jobsPane{z-index:1;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:8px;margin-top:4px;position:sticky;bottom:0;overflow:hidden;box-shadow:0 -6px 12px -8px #00000059}._2R3-3W_jobsPaneHeader{border-bottom:1px solid var(--dsw-alias-border-l1);align-items:center;gap:6px;height:28px;padding:0 4px 0 10px;display:flex}._2R3-3W_jobsPaneDot{flex:none}._2R3-3W_jobsPaneLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);line-height:var(--dsw-font-xxxs-11-line-height);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}._2R3-3W_jobsPaneStatus{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}._2R3-3W_jobsPaneClose{width:20px;height:20px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:5px;flex:none;justify-content:center;align-items:center;display:inline-flex}._2R3-3W_jobsPaneClose:hover{background:var(--dsw-alias-interactive-bg-hover)}._2R3-3W_jobsPanePre{max-height:200px;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;margin:0;padding:6px 10px;line-height:1.5;overflow:auto}._2R3-3W_jobsPaneHint{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);padding:8px 10px}._2R3-3W_jobsPaneError{color:var(--dsw-alias-state-error-primary)}";
		...
		var SubagentView_module_css_default = {
			"jobsPane": "_2R3-3W_jobsPane",
			"jobsLabelLine": "_2R3-3W_jobsLabelLine",
			"jobsPaneLabel": "_2R3-3W_jobsPaneLabel",
			"jobsKillError": "_2R3-3W_jobsKillError",
			"jobsPaneClose": "_2R3-3W_jobsPaneClose",
			"subagentEmptyHint": "_2R3-3W_subagentEmptyHint",
			"subagentCount": "_2R3-3W_subagentCount",
			"jobsKind": "_2R3-3W_jobsKind",
			"subagentDot": "_2R3-3W_subagentDot",
			"jobsRowSettled": "_2R3-3W_jobsRowSettled",
			"jobsLabel": "_2R3-3W_jobsLabel",
			"jobsHeader": "_2R3-3W_jobsHeader",
			"jobsPaneDot": "_2R3-3W_jobsPaneDot",
			"subagentNode": "_2R3-3W_subagentNode",
			"subagentErrorRetry": "_2R3-3W_subagentErrorRetry",
			"jobsRow": "_2R3-3W_jobsRow",
			"jobsPaneError": "_2R3-3W_jobsPaneError",
			"jobsCount": "_2R3-3W_jobsCount",
			"jobsDot": "_2R3-3W_jobsDot",
			"subagentLiveTool": "_2R3-3W_subagentLiveTool",
			"jobsRowMain": "_2R3-3W_jobsRowMain",
			"subagentError": "_2R3-3W_subagentError",
			"jobsContent": "_2R3-3W_jobsContent",
			"subagentLiveArgs": "_2R3-3W_subagentLiveArgs",
			"subagentLiveText": "_2R3-3W_subagentLiveText",
			"subagentSecondary": "_2R3-3W_subagentSecondary",
			"jobsList": "_2R3-3W_jobsList",
			"subagentChildren": "_2R3-3W_subagentChildren",
			"subagentRow": "_2R3-3W_subagentRow",
			"jobsPaneStatus": "_2R3-3W_jobsPaneStatus",
			"jobsPaneHint": "_2R3-3W_jobsPaneHint",
			"subagentRowActive": "_2R3-3W_subagentRowActive",
			"subagentTitle": "_2R3-3W_subagentTitle",
			"subagent": "_2R3-3W_subagent",
			"subagentRowDisabled": "_2R3-3W_subagentRowDisabled",
			"subagentEmpty": "_2R3-3W_subagentEmpty",
			"jobsTitle": "_2R3-3W_jobsTitle",
			"jobsSecondary": "_2R3-3W_jobsSecondary",
			"jobsKill": "_2R3-3W_jobsKill",
			"jobsPaneHeader": "_2R3-3W_jobsPaneHeader",
			"jobs": "_2R3-3W_jobs",
			"jobsPanePre": "_2R3-3W_jobsPanePre",
			"subagentLive": "_2R3-3W_subagentLive",
			"subagentHeader": "_2R3-3W_subagentHeader",
			"subagentLabel": "_2R3-3W_subagentLabel",
			"subagentRefresh": "_2R3-3W_subagentRefresh",
			"subagentRowLoading": "_2R3-3W_subagentRowLoading",
			"subagentBody": "_2R3-3W_subagentBody",
			"jobsRowSelected": "_2R3-3W_jobsRowSelected",
			"subagentContent": "_2R3-3W_subagentContent",
			"jobsKillArmed": "_2R3-3W_jobsKillArmed"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\TESTDS\dsh-better-sidebar\src\client\SideCardSection.module.css.mjs
		const css$1 = ".vypkEW_section{flex-direction:column;gap:14px;width:100%;height:100%;min-height:0;display:flex;overflow-y:auto}.vypkEW_intro{color:var(--dsw-alias-label-tertiary);margin:0;padding:0 2px;font-size:13px;line-height:20px}.vypkEW_group{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:16px;flex-direction:column;flex:none;gap:8px;padding:18px 20px 20px;display:flex}.vypkEW_groupHeading{color:var(--dsw-alias-label-primary);align-items:baseline;gap:7px;padding:0 2px 6px;font-size:13px;font-weight:600;line-height:20px;display:flex}.vypkEW_count{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px;font-weight:400;line-height:18px}.vypkEW_grid{grid-template-columns:repeat(auto-fill,minmax(168px,1fr));gap:10px;display:grid}.vypkEW_card{border:1px solid var(--dsw-alias-border-l2);font:inherit;color:inherit;cursor:pointer;background:0 0;border-radius:12px;flex-direction:column;transition:background .12s,border-color .12s;display:flex;position:relative}.vypkEW_card:not(.vypkEW_cardOn):hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-label-dimmed)}.vypkEW_cardOn{border-color:var(--dsw-alias-button-primary-fill);background:var(--dsw-alias-interactive-bg-active)}.vypkEW_cardMain{border-radius:inherit;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;flex-direction:column;gap:6px;padding:12px;display:flex}.vypkEW_cardMain:focus-visible,.vypkEW_cardGear:focus-visible,.vypkEW_rowGear:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:2px}.vypkEW_cardTop{align-items:center;gap:8px;min-width:0;display:flex}.vypkEW_cardIconChip{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);width:28px;height:28px;color:var(--dsw-alias-label-tertiary);border-radius:8px;flex:none;justify-content:center;align-items:center;display:inline-flex}.vypkEW_cardOn .vypkEW_cardIconChip{border-color:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 35%, transparent);background:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 12%, transparent);color:var(--dsw-alias-button-primary-fill)}.vypkEW_cardTitle{min-width:0;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;flex:1;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.vypkEW_cardOn .vypkEW_cardTitle{color:var(--dsw-alias-label-primary)}.vypkEW_cardCheck{background:var(--dsw-alias-button-primary-fill);width:16px;height:16px;color:var(--dsw-alias-bg-layer-3);border-radius:50%;flex:none;justify-content:center;align-items:center;display:inline-flex}.vypkEW_cardDesc{color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;font-size:11px;line-height:16px;overflow:hidden}.vypkEW_addCard{border-style:dashed;border-color:var(--dsw-alias-border-l2);text-align:left;align-items:flex-start;padding:12px}.vypkEW_addCard:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-label-primary)}.vypkEW_addCard:hover .vypkEW_cardTitle{color:var(--dsw-alias-label-primary)}.vypkEW_addCard:hover .vypkEW_cardIconChip{border-color:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 35%, transparent);color:var(--dsw-alias-button-primary-fill)}.vypkEW_addCard:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:2px}.vypkEW_cardOn .vypkEW_cardDesc{color:var(--dsw-alias-label-secondary)}.vypkEW_cardWithGear .vypkEW_cardDesc{padding-right:30px}.vypkEW_cardGear{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:50%;justify-content:center;align-items:center;padding:0;display:inline-flex;position:absolute;top:46px;right:12px}.vypkEW_cardGear:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.vypkEW_rowGear{width:22px;height:22px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.vypkEW_rowGear:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.vypkEW_row{border-bottom:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:16px;padding:12px 2px;display:flex}.vypkEW_row:last-child{border-bottom:none}.vypkEW_rowText{flex-direction:column;gap:4px;min-width:0;display:flex}.vypkEW_title{color:var(--dsw-alias-label-primary);font-size:14px;line-height:22px}.vypkEW_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.vypkEW_switch{cursor:pointer;flex:none;display:inline-flex;position:relative}.vypkEW_switchInput{opacity:0;width:1px;height:1px;margin:0;position:absolute}.vypkEW_switchTrack{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:10px;align-items:center;width:36px;height:20px;padding:2px;transition:background .15s,border-color .15s;display:inline-flex}.vypkEW_switchThumb{background:var(--dsw-alias-label-secondary);border-radius:50%;width:14px;height:14px;transition:transform .15s,background .15s;display:block}.vypkEW_switch:hover .vypkEW_switchTrack{border-color:var(--dsw-alias-label-dimmed)}.vypkEW_switchInput:checked+.vypkEW_switchTrack{border-color:var(--dsw-alias-button-primary-fill);background:var(--dsw-alias-button-primary-fill)}.vypkEW_switchInput:checked+.vypkEW_switchTrack .vypkEW_switchThumb{background:var(--dsw-alias-bg-layer-3);transform:translate(16px)}.vypkEW_switchInput:focus-visible+.vypkEW_switchTrack{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.vypkEW_control{flex:none;align-items:center;gap:6px;display:flex}.vypkEW_percentInput{width:76px}.vypkEW_typedInput{width:200px}.vypkEW_typedInputNumber{width:76px}.vypkEW_suffix{color:var(--dsw-alias-label-secondary);font-size:14px;line-height:22px}.vypkEW_popupDialog.vypkEW_popupDialog{width:min(460px,100%)}.vypkEW_popupRows{flex-direction:column;width:100%;display:flex}.vypkEW_popupRow{border-bottom:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:16px;padding:14px 2px;display:flex}.vypkEW_popupRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.vypkEW_popupRows>:last-child{border-bottom:none}.vypkEW_done{appearance:none;font:inherit;cursor:pointer;background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.vypkEW_done:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}.vypkEW_error{color:var(--dsw-alias-state-error-primary);padding:10px 0 2px;font-size:12px;line-height:17px}.vypkEW_pluginModal.vypkEW_pluginModal{width:min(560px,100%)}.vypkEW_pluginList{flex-direction:column;gap:12px;width:100%;display:flex}.vypkEW_pluginTopicBtn{appearance:none;border:1px solid var(--dsw-alias-border-l2);width:100%;font:inherit;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);cursor:pointer;border-radius:8px;padding:6px 12px;font-size:12px;line-height:18px}.vypkEW_pluginTopicBtn:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-label-primary)}.vypkEW_pluginTopicBtn:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:1px}.vypkEW_pluginEmpty{color:var(--dsw-alias-label-tertiary);padding:20px 2px;font-size:12px;line-height:18px}.vypkEW_pluginEntries{flex-direction:column;gap:10px;display:flex}.vypkEW_pluginEntry{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:12px;flex-direction:column;gap:4px;padding:12px;display:flex}.vypkEW_pluginEntryHead{justify-content:space-between;align-items:center;gap:12px;display:flex}.vypkEW_pluginEntryActions{flex:none;align-items:center;gap:6px;display:inline-flex}.vypkEW_pluginJumpBtn{appearance:none;border:1px solid var(--dsw-alias-border-l2);font:inherit;cursor:pointer;color:var(--dsw-alias-label-secondary);background:0 0;border-radius:8px;flex:none;padding:3px 12px;font-size:12px;line-height:1.5}.vypkEW_pluginJumpBtn:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-label-primary)}.vypkEW_pluginJumpBtn:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:1px}.vypkEW_pluginName{appearance:none;min-width:0;font:inherit;color:var(--dsw-alias-label-primary);text-align:left;text-overflow:ellipsis;white-space:nowrap;cursor:pointer;background:0 0;border:0;padding:0;font-size:13px;font-weight:600;line-height:20px;text-decoration:none;overflow:hidden}.vypkEW_pluginName:hover{color:var(--dsw-alias-button-primary-fill);text-decoration:underline}.vypkEW_pluginDesc{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}.vypkEW_pluginInstall{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l1);white-space:nowrap;border-radius:8px;padding:6px 10px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;line-height:16px;display:block;overflow-x:auto}.vypkEW_pluginCopyBtn{appearance:none;font:inherit;cursor:pointer;background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);border:1px solid #0000;border-radius:8px;flex:none;padding:3px 12px;font-size:12px;line-height:1.5}.vypkEW_pluginCopyBtn:hover{background:var(--dsw-alias-button-primary-hover)}.vypkEW_pluginCopyBtn:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}@media (prefers-reduced-motion:reduce){.vypkEW_card,.vypkEW_switchTrack,.vypkEW_switchThumb{transition:none}}";
		...
		var SideCardSection_module_css_default = {
			"pluginJumpBtn": "vypkEW_pluginJumpBtn",
			"grid": "vypkEW_grid",
			"addCard": "vypkEW_addCard",
			"cardTitle": "vypkEW_cardTitle",
			"title": "vypkEW_title",
			"done": "vypkEW_done",
			"intro": "vypkEW_intro",
			"cardTop": "vypkEW_cardTop",
			"cardCheck": "vypkEW_cardCheck",
			"count": "vypkEW_count",
			"cardDesc": "vypkEW_cardDesc",
			"switch": "vypkEW_switch",
			"suffix": "vypkEW_suffix",
			"popupRows": "vypkEW_popupRows",
			"pluginTopicBtn": "vypkEW_pluginTopicBtn",
			"pluginName": "vypkEW_pluginName",
			"pluginCopyBtn": "vypkEW_pluginCopyBtn",
			"pluginEntryActions": "vypkEW_pluginEntryActions",
			"popupRow": "vypkEW_popupRow",
			"cardMain": "vypkEW_cardMain",
			"cardGear": "vypkEW_cardGear",
			"pluginEmpty": "vypkEW_pluginEmpty",
			"section": "vypkEW_section",
			"desc": "vypkEW_desc",
			"group": "vypkEW_group",
			"pluginDesc": "vypkEW_pluginDesc",
			"pluginEntries": "vypkEW_pluginEntries",
			"rowGear": "vypkEW_rowGear",
			"pluginEntry": "vypkEW_pluginEntry",
			"rowText": "vypkEW_rowText",
			"typedInput": "vypkEW_typedInput",
			"percentInput": "vypkEW_percentInput",
			"switchThumb": "vypkEW_switchThumb",
			"row": "vypkEW_row",
			"groupHeading": "vypkEW_groupHeading",
			"pluginEntryHead": "vypkEW_pluginEntryHead",
			"cardIconChip": "vypkEW_cardIconChip",
			"switchInput": "vypkEW_switchInput",
			"cardWithGear": "vypkEW_cardWithGear",
			"control": "vypkEW_control",
			"error": "vypkEW_error",
			"cardOn": "vypkEW_cardOn",
			"pluginModal": "vypkEW_pluginModal",
			"switchTrack": "vypkEW_switchTrack",
			"typedInputNumber": "vypkEW_typedInputNumber",
			"popupDialog": "vypkEW_popupDialog",
			"pluginList": "vypkEW_pluginList",
			"pluginInstall": "vypkEW_pluginInstall",
			"card": "vypkEW_card"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\TESTDS\dsh-better-sidebar\src\client\layout.css.mjs
